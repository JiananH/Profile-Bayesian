...
n_pp <- n_p[1]
# H00-1
res_I <- function(x)Bayes_continuous(mu_a=1,var_a=7^2,n_a=1000,n_p=n_pp,mu_p=0,var_p=5^2,n.samples=intensity,alpha=0.025,rep=intensity,gamma = x)
...
# H00-2
res_I <- function(x)Bayes_continuous(mu_a=1,var_a=7^2,n_a=1000,n_p=n_pp,mu_p=0,var_p=7^2,n.samples=intensity,alpha=0.025,rep=intensity,gamma = x)
SI <- sapply(r_gamma,res_I)
SI_res <- t(SI)
...
# H00-3
res_I <- function(x)Bayes_continuous(mu_a=1,var_a=7^2,n_a=1000,n_p=n_pp,mu_p=0,var_p=10^2,n.samples=intensity,alpha=0.025,rep=intensity,gamma = x)
SI <- sapply(r_gamma,res_I)
SI_res <- t(SI)
...
# H11-1
res_I <- function(x)Bayes_continuous(mu_a=1,var_a=7^2,n_a=1000,n_p=n_pp,mu_p=0.8,var_p=7^2,n.samples=intensity,alpha=0.025,rep=intensity,gamma = x)
SI <- sapply(r_gamma,res_I)
SI_res <- t(SI)
...
# H11-2
res_I <- function(x)Bayes_continuous(mu_a=1,var_a=7^2,n_a=1000,n_p=n_pp,mu_p=1,var_p=7^2,n.samples=intensity,alpha=0.025,rep=intensity,gamma = x)
SI <- sapply(r_gamma,res_I)
SI_res <- t(SI)
...
# H11-3
res_I <- function(x)Bayes_continuous(mu_a=1,var_a=7^2,n_a=1000,n_p=n_pp,mu_p=1.5,var_p=7^2,n.samples=intensity,alpha=0.025,rep=intensity,gamma = x)
SI <- sapply(r_gamma,res_I)
SI_res <- t(SI)
...
####
save.image("VaryNVaryR_adding more sample sizes for VaryR.RData")
