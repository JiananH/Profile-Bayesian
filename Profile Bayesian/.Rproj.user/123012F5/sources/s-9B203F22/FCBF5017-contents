...
res_I <- function(x)Bayes_discrete(n_a=1000,p_a=0.7,n_p=x,p_p=0.7,n.samples=10^4,p_target=0.5,alpha=0.025,rep=10^4)
...
res_II <- function(x)Bayes_discrete(n_a=1000,p_a=0.7,n_p=x,p_p=0.6,n.samples=10^4,p_target=0.5,alpha=0.025,rep=10^4)
ss_p=c(1000,800,600,400,200,100,50,25)
...
res_III <- function(x)Bayes_discrete(n_a=1000,p_a=0.7,n_p=x,p_p=0.5,n.samples=10^4,p_target=0.5,alpha=0.025,rep=10^4)
ss_p=c(1000,800,600,400,200,100,50,25)
...
# res_IV <- function(x)Bayes_discrete(n_a=1000,p_a=0.7,n_p=x,p_p=0.6,n.samples=10^4,p_target=0.5,alpha=0.025,rep=10^4)
# ss_p=c(1000,800,600,400,200,100,50,25)
